...
include('include/config.php'); 
  ...
  if (isset($_POST['p_name'])) {
    ...
    $cmt = $_POST['cmt'];
    $qty = $_POST['qty'];
    $query = "INSERT INTO sale (uid,p_name,challan_no,si_no,gaddi_no,builty,sgst,cgst,tcs,lbr,total,transporter,due_days,nrtn,cash_amt,check_amt,inv_date)VALUES
   ...
   $j = 0;
        ...
        foreach ($m_type as $m_type2) {
            ...
            $ptype2 =  $ptype[$j];
            $subtype2 =  $subtype[$j];
      $query = "INSERT INTO sale (uid,order_id,p1,p2,p3,p4,p5,qty,m_type,cat_id,ptype,subtype)VALUES
    ...
    if ($query) {
        ...
        window.location="Sales-form.php";
        </script>';
    } else {
                                   	...
                                   	<table id="example133" class="table">
                                        ...
                                        <div class="col-lg-2">
                                         ...
                                         <div class="col-lg-1">
                                            ...
                                            <select class="form-select form-control" name="m_type[]" onchange="mchange2(this.value, 0)" id="mchange"
                                         ...
                                         <div class="col-lg-6">
                                                ...
                                                <input type="number" name="mt[]" class="form-control"
                                                    ...
                                                    placeholder="T(inch)" id="mt0" oninput="myFunction2(0)" required>
                                            ...
                                            <div class="col-md-2 mb-1">
                                                ...
                                                <input type="number" name="mw[]" class="form-control"
                                                    ...
                                                    placeholder="W(In inch)" id="mw0" oninput="myFunction2(0)" required>
                                            ...
                                            <div class="col-md-2 mb-1">
                                                ...
                                                <input type="number" name="ml[]" class="form-control" placeholder="L(In ft)"
                                                    ...
                                                    id="ml0" oninput="myFunction2(0)" required>
                                              ...
                                              <div class="col-md-2 mb-1">
                                                ...
                                                <input type="number" name="qty[]" class="form-control" placeholder="qty"
                                                    ...
                                                    id="qty0" oninput="myFunction2(0)" required>
                                           ...
                                           <div class="row" id="ply0" style="display:none;">
                                            ...
                                            <div class="col-md-2 mb-1">
                                                ...
                                                <input type="number" name="mt2[]" class="form-control"
                                                    ...
                                                    placeholder="W(ft)" id="mt20" oninput="ply(0)" required>
                                            ...
                                            <div class="col-md-2 mb-1">
                                                ...
                                                <input type="number" name="mw2[]" class="form-control"
                                                    ...
                                                    placeholder="L(ft)" id="mw20" oninput="ply(0)">
                                               ...
                                               <div class="col-md-2 mb-1">
                                                ...
                                                <input type="text" name="qty2[]" class="form-control"
                                                    ...
                                                    placeholder="qty" id="qty20" oninput="ply(0)">
                                            ...
                                            <div class="col-md-2 mb-1">
                                                ...
                                                <input type="text" name="sqft[]" readonly class="form-control" placeholder="SQFT"
                                            ...
                                            <div class="col-md-2 mb-1">
                                                ...
                                                <input type="number" name="sqmt[]" readonly class="form-control"

                                                    placeholder="SQMT" id="sqmt0">
...
<style>
    .removeclass{position:absolute; right:10px;}
    </style>
