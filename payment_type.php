											...
											<div class="card-header">
												<?php if(isset($_GET['act'])){
															...
															if($act=='del'){
																...
																$st=$_GET['st'];
																if(isset($_GET['st']))
																$queryu ="update payment_type set status='$st' where id = '$pid'";
																else 
																$queryu ="delete FROM payment_type where id = '$pid'";

																$result = $db->query($queryu); echo"Updated.";
															}
													}
												?>
											<a href="new_payment_type.php"><h3><i class="fa fa-plus"></i> Add New Chart of Account</h3></a>	 
                                         	<div class="card-body">
                                             	<table id="example1" class="table table-bordered table-responsive-xl table-hover display">
													...
													<tbody> 
														<?php 		 
														$queryu ="SELECT payment_type.*, ac_heads.ac_name FROM payment_type LEFT JOIN ac_heads ON payment_type.ac_head=ac_heads.id order by payment_type.payment_type_name asc";
                                                        ...
                                                        ?>
													 	<tr>
															...
															<br/>	<br/>
															<a href="new_payment_type.php?act=edit&pid=<?php echo  $row['id'];?>">Edit</a>
														</td>
