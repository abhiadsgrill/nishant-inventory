	        ...
	        <div id="sidebar-menu">
	            ...
	            <ul>
	                ...
	                <li class="submenu">
	                    ...
	                    <a class="active" href="dashboard.php"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
	                ...
	                <li class="submenu">
	                    ...
	                    <ul class="list-unstyled">
	                        ...
	                        <li><a href="user_list.php">View User</a></li>
	                ...
	                <li class="submenu">
	                    ...
	                    <a href="#"><i class="fa fa-fw fa-user"></i> <span> Vendor List</span> <span class="menu-arrow"></span></a>

	                    <ul class="list-unstyled">
	                        <li><a href="client-list.php">Add Vendor</a></li>
	                    </ul>
	                ...
	                <li class="submenu">
	                    ...
	                    <a href="#"><i class="fa fa-fw fa-indent"></i><span>Inventory Stock</span> <span class="menu-arrow"></span></a>

	                    <ul class="list-unstyled">

	                        <li><a href="catogery.php">Catagories</a></li>

	                        <li><a href="ptype.php">Product type</a></li>

	                        <li><a href="product_subtype.php">Subtype</a></li>

	                        <li><a href="measurment.php">measurment</a></li>

	                        <li><a href="inventory_form.php">Add Stock</a></li>

	                        <li><a href="stock-list.php">View Stock </a></li>

	                        <li><a href="purchase-form.php"> Purchase Form </a></li>

	                        <li><a href="purchase-report.php"> Purchase Report </a></li>
							
	                        <li><a href="purchase-return-form.php"> Purchase Return Form </a></li>
	                ...
	                <li class="submenu">
	                    <a href="#"><i class="fa fa-fw fa-indent"></i><span>Sales Stock</span> <span class="menu-arrow"></span></a>
	                    <ul class="list-unstyled">
	                        <li><a href="sales_stock.php ">Add Sales Inventory </a></li>
	                        <li><a href="#">View Sales Stock </a></li>

	                        <li><a href="sales-stock-2.php"> Sales </a></li>
	                        <li><a href="sales-report.php">Sales Report</a></li>
	                        <li><a href="daybook-import.php"> Daybook Import	 </a></li>
	                    </ul>
	                </li>

	                <li class="submenu">
	                    <a href="#"><i class="fa fa-fw fa-table"></i> <span> Account </span> <span class="menu-arrow"></span></a>
	                    <ul class="list-unstyled">
	                        <li><a href="account.php">Add Account</a></li>
	                        <li><a href="payment_type.php">Chart of Accounts</a></li>
	                        <li><a href="ac_heads.php">Head of Accounts</a></li>
	                        <li><a href="report-graph-ac.php">Account Graph Report</a></li>
	                        <li><a href="payment-report2.php">View Account Payments</a></li>
	                        <li><a href="sundry-debtors.php">Sundry Debtors</a></li>
	                        <li><a href="sundry-creditors.php">Sundry Creditors</a></li>
	                    </ul>
	                </li>
