  ...
  <?php 
  if (!isset($_SESSION['useradmin'])) { echo '<script>window.location ="index.php";</script>'; } ?>
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="dashboard.php" class="logo"> ADS <span>Grill</span> (LOGO) </a>
        </div>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notif">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                <!-- item-->
                                <div class="dropdown-item noti-title">
                                    <h5 class="text-overflow"><small>Hello, <?php echo $_SESSION['admin_name'] ?></small> </h5>
                                </div>
