...
<div id="main">
  ...
  <div class="content-page">
    ...
    <div class="content">
        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="breadcrumb-holder">
              <h3 class="main-title float-left">sale Report</h3>
              <ol class="breadcrumb float-right">
                <td class="breadcrumb-item">Inventory Stock </td>
                <td class="breadcrumb-item active">sale Report/li>
              </ol>
      ...
      <?php
      $query = "SELECT * FROM sale WHERE inv_no='$inv_no'";
      ...
      <div class="container bg-light">
        ...
        <table class="table bg-light">
          <tbody>
            ...
            <tr>
              ...
              <td>sale Created On : <?php echo $date; ?> </td>
            </tr>
          </tbody>
        </table>
        <br>
        ...
        <?php 
          $sql = "SELECT * FROM products_sale WHERE inv_no='$inv_no'" or die(mysqli_error($db));
          $result = $db->query($sql);
