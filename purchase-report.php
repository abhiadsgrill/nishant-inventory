				...
				<div class="row">
                    ...
                    <table id="example1" class="table table-bordered table-responsive-xl table-hover display">
                        ...
                        <thead>
							...
							$purchase_report_query = "SELECT * FROM purchase ORDER BY inv_no  DESC  ";
							$purchase_query_result = $db->query($purchase_report_query);
							$result = $db->query($queryu);
								$i=1;
								while($row=mysqli_fetch_array($purchase_query_result))
								{
							...
							<tr>
								...
								<td><a href="purchase-report-more.php?inv
