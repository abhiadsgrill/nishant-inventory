            	...
            	<div class="row">
						<div class="col-xl-12">
								<div class="breadcrumb-holder">
										<h3 class="main-title float-left">Sundry Debtors</h3>
										<ol class="breadcrumb float-right">
											<li class="breadcrumb-item">Accounts</li>
											<li class="breadcrumb-item active">Sundry Debtors</li>
										</ol>
				...
				<div class="row">
                    ...
                    <table id="example1" class="table table-bordered table-responsive-xl table-hover display">
                        ...
                        <thead>
							...
							$debtors_report_query = "SELECT * FROM purchase ORDER BY inv_date  DESC  ";
							$debtors_query_result = $db->query($debtors_report_query);
								$i=1;
								while($row=mysqli_fetch_array($debtors_query_result))
								{
